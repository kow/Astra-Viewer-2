...
public:
	...
	virtual BOOL	parseString(const std::string &string, BOOL keep_contents = TRUE); // S21
...
public:
	...
	BOOL parseString(const std::string &string, LLXmlTreeNode** root, BOOL keep_contents); // S21
