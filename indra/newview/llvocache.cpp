...
//const U32 MAX_NUM_OBJECT_ENTRIES = 128 ; //uhm... nyx say this isn't good...
...
//	mCacheSize = llclamp(size, MAX_NUM_OBJECT_ENTRIES, NUM_ENTRIES_TO_PURGE); //this too as before same commit
