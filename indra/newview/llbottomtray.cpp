...
#include "llfloatersidebarctrl.h" // S20 KL
...
void LLBottomTray::initResizeStateContainers()
{
	...
	mStateProcessedObjectMap.insert(std::make_pair(RS_BUTTON_SIDEBAR, getChild<LLPanel>("sidebar_btn_panel"))); //S20
	...
	mStateProcessedObjectMap.insert(std::make_pair(RS_BUTTON_INVENTORY, getChild<LLPanel>("inventory_btn_panel"))); // S20
	...
	mButtonsProcessOrder.push_back(RS_BUTTON_SIDEBAR); //S20
    ...
    mButtonsProcessOrder.push_back(RS_BUTTON_INVENTORY); // S20
...
void LLBottomTray::initButtonsVisibility()
{
	...
	setVisibleAndFitWidths(RS_BUTTON_SIDEBAR, gSavedSettings.getBOOL("ShowSidebarButton")); //S20
	...
	setVisibleAndFitWidths(RS_BUTTON_INVENTORY, gSavedSettings.getBOOL("ShowInventoryButton")); // S20
}

void LLBottomTray::setButtonsControlsAndListeners()
{
	gSavedSettings.declareBOOL("ShowInventoryButton", TRUE, "Shows/Hides Inventory button in the bottom tray. (Declared in code)"); // S20
	...
	gSavedSettings.getControl("ShowSidebarButton")->getSignal()->connect(boost::bind(&LLBottomTray::toggleShowButton, RS_BUTTON_SIDEBAR, _2)); // S20
    ...
    gSavedSettings.getControl("ShowInventoryButton")->getSignal()->connect(boost::bind(&LLBottomTray::toggleShowButton, RS_BUTTON_INVENTORY, _2)); // S20
