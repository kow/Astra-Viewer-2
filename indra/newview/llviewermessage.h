...
#include "lluuid.h"
#include "llnearbychat.h" // a test to replace llchat
#include "message.h"
#include "stdenums.h"
...
void add_translate_chat(const LLChat& chat, const BOOL history); // S21
void check_translate_chat(const std::string& mesg, LLChat& chat, const BOOL history); // S21
