	...
	mPropertiesRequest(NULL)
{
	...
	mCommitCallbackRegistrar.add("InspectAvatar.CopyUUID",	boost::bind(&LLInspectAvatar::copyUUID, this));	 // S20
...
void LLInspectAvatar::copyUUID() // S20
{
